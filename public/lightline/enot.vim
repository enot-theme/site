...
if &background ==# 'light'
  ...
  let s:red = [ '#a95359', 88 ]
  let s:green = [ '#6a6c28', 58 ]
  let s:yellow = [ '#68573d', 94 ]
  let s:blue = [ '#187886', 24 ]
  let s:purple = [ '#9a5073', 125 ]
else
  ...
  let s:red = [ '#daa3a2', 174 ]
  let s:green = [ '#bbb97d', 186 ]
  let s:yellow = [ '#ae925d', 179 ]
  let s:blue = [ '#65b7c6', 109 ]
  let s:purple = [ '#cb87a2', 218 ]
endif
